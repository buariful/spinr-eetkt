        ...
        <div className="beachEvent__service">
          <div className="beService__box">
            <div className="be__img">
              <img
                src={require("../../../assets/img/icon/Favorite.png")}
                alt=""
              />
            </div>
          ...
          <div className="beService__box">
            <div className="be__img">
              <img src={require("../../../assets/img/icon/Clock.png")} alt="" />
            </div>
            <div className="be__text">
              <h6>Start Time</h6>
              <p>21:00</p>
          ...
          <div className="beService__box">
            <div className="be__img">
              <img
                src={require("../../../assets/img/icon/Infinity.png")}
                alt=""
              />
            </div>
            <div className="be__text">
          ...
          <div className="beService__box">
            <div className="be__img">
              <img
                src={require("../../../assets/img/icon/Island On Waters.png")}
                alt=""
              />
            </div>
            <div className="be__text">
