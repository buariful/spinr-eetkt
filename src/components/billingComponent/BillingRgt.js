    ...
    <>
      <div class="insDetails__right">
        <div class="wt__box border-bottom border-2 border-dark">
          ...
          <ul>
            <li>
              <i class="ri-star-s-fill"></i> Competitive prices. One of the main
              factors to consider when choosing a trip is its price.
            </li>
            <li>
