...
const HotelSideBar = () => {
  ...
  let timeChart = (
    <div className="containerw-100 border border-2 border-end-0 border-dark rounded mb-4">
      <div className="row mw-100 mx-auto">
        ...
        <button className="col p-0 bg-transparent border-0 border-end border-dark d-flex flex-column justify-content-center align-items-center rounded">
          <i className="ri-flight-takeoff-line"></i>
          <p style={{ fontSize: "12px" }}>00-06</p>
        </button>
      </div>
  ...
  return (
    <div className="flight__left__filter">
      <h4 style={{ color: "#FF6B00" }} className="border-bottom p-4">
        FILTER BY <i className="ri-filter-3-fill"></i>
      </h4>
